...
<#macro header>
    <header class="header_view_container">
        <section class="header_container_offset">
            <div class="header_container">
                <div class="menu_bar">
                    <a class="menu_bar__logo logo" href="/static/css/index.css">
                ...
                <div class="user_bar">
                    ...
                    <a class="user_bar__sign button" href="/sigin">
                        Войти
                    </a>
                </div>
            </div>
